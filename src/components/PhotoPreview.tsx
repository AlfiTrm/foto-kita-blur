...
export function PhotoPreview({ photoDataUrl }: PhotoPreviewProps) {
  if (!photoDataUrl) {
    return (
  ...
  return (
    <div className="size-10 overflow-hidden rounded-full border border-white shadow-[0_10px_24px_rgba(24,39,75,0.08)]">
      <img
        src={photoDataUrl}
